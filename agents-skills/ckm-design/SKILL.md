---
name: ckm:design
description: 全方位設計技能：品牌識別、設計代號、UI 樣式、標誌生成（55 種風格，Gemini AI）、企業識別系統（50 項交付物，CIP 模型）、HTML 簡報（Chart.js）、橫幅設計（22 種風格，社交/廣告/網路/印刷）、圖示設計（15 種風格，SVG，Gemini 3.1 Pro）、社交照片（HTML 轉螢幕截圖，多平台）。動作：設計標誌、建立 CIP、生成模型、建立簡報、設計橫幅、生成圖示、建立社交照片、社交媒體圖片、品牌識別、設計系統。平台：Facebook、Twitter、LinkedIn、YouTube、Instagram、Pinterest、TikTok、Threads、Google Ads。
