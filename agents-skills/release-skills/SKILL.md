---
name: release-skills
description: 通用發布工作流程。自動偵測版本檔案與變更日誌。支援 Node.js、Python、Rust、Claude Plugin、GitHub Releases、附註標籤、歷史發布回填，以及一般專案。當使用者說 release、發布、new version、bump version、push、推送、release notes、GitHub Release 或回填 Release 時使用。
---
