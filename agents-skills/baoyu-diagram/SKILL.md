---
name: baoyu-diagram
description: 建立任何類型的專業深色主題 SVG 圖表 — 架構圖、流程圖、循序圖、結構圖、心智圖、時間軸、插圖/概念圖等。每當使用者要求任何技術或概念圖表、系統視覺化、流程、資料流、元件關係、網路拓撲、決策樹、組織圖、狀態機，或任何結構/邏輯/流程的視覺呈現時使用。也當使用者說「畫個圖」、「畫一個架構圖」或要求繪製圖表時觸發。輸出始終為獨立的 .svg 檔案。
version: 1.117.3
---
